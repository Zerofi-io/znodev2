...
class Logger {
  ...
  redactSensitive(obj) {
    ...
    const sensitiveKeys = [
      'password', 'privatekey', 'private_key', 'secret', 'mnemonic', 'seed',
      'passphrase', 'backup_passphrase', 'wallet_backup_passphrase',
      'rpc_login', 'login', 'wallet_password', 'monero_wallet_password',
      'rpc_user', 'rpc_password', 'monero_wallet_rpc_user', 'monero_wallet_rpc_password',
      'key', 'api_key', 'apikey', 'bearer', 'authorization', 'cookie'
    ];
    ...
    for (const key of Object.keys(redacted)) {
      ...
      const isPatternMatch = sensitivePatterns.some(pattern => 
